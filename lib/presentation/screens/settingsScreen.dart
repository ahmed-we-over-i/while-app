                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: const Text('Done', style: TextStyle(color: Colors.black54)),
                    )
                  ],
                ),
              ),
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
        leading: Material(
          child: IconButton(icon: const Icon(Icons.close, size: 18, color: Colors.grey), onPressed: () => Navigator.of(context).pop()),
        ),
